...
if (mysqli_num_rows($result_1)>0){
    ...
    $sql_2 = "insert into db_users(username_guest, password_guest, email_guest, phone_guest, address_guest) 
    values ('$username_guest','$pass_hash','$email_guest','$phone_guest','$address_guest')";
