                    ...
                    <div class="booking-form">
                        ...
                        <form method="POST" class="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <img src="../images/<?php echo $row['img_guest']; ?>" width="150 px">
                            </div>
                            <div class="form-group">
                            ...
                            if (isset($_POST['update-guest-table'])) {
                                ...
                                $sql = "UPDATE db_users SET fullname_guest='$fullname_guest',phone_guest = '$phone_guest', img_guest='$image_name', 
email_guest='$email_guest',address_guest ='$address_guest'  WHERE id_guest='$id_guest'";
