<?php
  if(isset($_POST['btnAdd'])){
    ...
    $sql ="INSERT INTO db_rooms(name_rm,area_rm,capacity_rm,des_rm,image_rm,available_rm,price_rm) VALUES('$name_rm','$area_rm','$capacity_rm','$des_rm','$image_name','$available_rm','$price_rm')";
