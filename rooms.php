      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Trang Chủ</a></span> <span><a href="about.php">Giới Thiệu</a></span></p>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<h3 class="mb-3"><a href="rooms-single.php">Phòng Thường</a></h3>
	    						<p class="pt-1"><a href="rooms-single.php" class="btn-custom px-3 py-2">Xem Chi Tiết Phòng <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">7.000.000VNĐ</span> <span class="per">một đêm</span></p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Hilton</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">1 Le Thanh Tong ,Hoan Kiem Dist, Ha Noi 10000, Viet Nam</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">024 3933 0500</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">hanoi.opera@hilton.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
